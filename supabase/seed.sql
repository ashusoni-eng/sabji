...
do $$ declare v_p uuid; begin
  insert into public.products (category_id, name, description, badge, sort_order, image_url)
  select id, 'Aam (Mango)', 'Premium Alphonso quality.', 'Season''s Best', 5, 'https://lh3.googleusercontent.com/aida-public/AB6AXuC1I8JinzWIL01lHe6ez5VO8qAkLpw5MwcdulVexThVcW2ZTRu8kAy1vCzMxveczcMnW0C0JSASuVoPNkYR990CwGVjlbjaoWjkIXLIMQdjuEXCTOL_SziOWtjO4C2Vwg49PlEmt7Tp7BwSY5tFUu43N69FAIOcqJs26FHA_D1uHj6i1g_nFwXGLnydNs0PPMOXoxe_zAYIp8t9woUsM5J3uagubHYyWAW2Y9JyZdrucBs1IttJwHVPs6yQu7TghG8zmkYWzHXsLiI'
    from public.categories where slug = 'fruits'
  returning id into v_p;
  insert into public.product_variants (product_id, label, unit, price_paise, sort_order)
  values (v_p, 'Default', '1 kg', 20000, 0);
...
do $$ declare v_p uuid; begin
  insert into public.products (category_id, name, description, badge, sort_order, image_url)
  select id, 'Bhindi (Ladyfinger)', 'Tender, snaps clean.', null, 6, 'https://lh3.googleusercontent.com/aida-public/AB6AXuCdGCGPOLjqMRjoLhc3YreNcbnzcpDgDVbV6Fb_JkCfFU67s8Zj_fzIW_1Py_YFUEM_SvKPVJZ70JwH598jBD6DogpW3e2KxM5kFUdLDi0QynkTzZciPOZcX-DDVc5Znp0uoAkplUqewvgNpw2u02A2PomfR2H4zIXE7LG5oDIJHNkOCE2JQFI4BAL5iUBmMJ1rOjzsm-rvL_Ai79fyChvph5TpSboU-R0Yl754LXmBae1ttiwyfvdD9kc7-LrnNkGrVn23AlbNCB4'
...
do $$ declare v_p uuid; begin
  insert into public.products (category_id, name, description, badge, sort_order, image_url)
  select id, 'Tamatar (Tomato)', 'Hybrid for curries, desi for chutney.', null, 7, 'https://lh3.googleusercontent.com/aida-public/AB6AXuA46N76KQGTOyBwyRKF6YznvPvE9p4yLVbuKUendV78XS0SDKFHUv08PIYC_DLkCAIob2KdxVsFEqb6xPqqeTIs22tjcsJ5qBc6WgQo9UcmFB-a4pn7bqEyVrYvviQQglxyENwqYh0Afppl2TjIUv1WqHHAGcZU4Sv_GaAT9QPaPK3w2uBe2_AWf_cGxRmNVbyVah_PFk3e6550dL-R4_W4xzMP4RQNW804iDYT8J8aD1j4Pf5As739ggOYEitVR_Tr6K0frMuQVUk'
    from public.categories where slug = 'vegetables'
  returning id into v_p;
  insert into public.product_variants (product_id, label, unit, price_paise, sort_order)
...
do $$ declare v_p uuid; begin
  insert into public.products (category_id, name, description, badge, sort_order, image_url)
  select id, 'Peyaj (Onion)', 'Firm with dry skin. Bulk rate available.', null, 8, 'https://lh3.googleusercontent.com/aida-public/AB6AXuD7rlPFAEVwmwHxaMkSc9egEU8KkUC49ZHbEgMvNtnchI0nV5mGGtGXkS_4cF2cl19pvM1AM48tZAZszzdxQ_sSsFfn2_tVHIlFhfOkQMPoh8cy3cvkSCp8dpsWERneHBQWhNrBjMz0YDPyVFrGTTRYqanSmrBcyeEAxgDy_61rSBok20uprVyHCzTO57UCMTj_tv8n6-hF86OA_rfiEmSxVKTn674GhPJd6zmUoFoyGVvEyEOKLzk7uwy98H1H7I9HjkKhAr5jhR4'
    from public.categories where slug = 'vegetables'
  returning id into v_p;
  insert into public.product_variants (product_id, label, unit, price_paise, sort_order)
...
do $$ declare v_p uuid; begin
  insert into public.products (category_id, name, description, badge, sort_order, image_url)
  select id, 'Aalu (Potato)', 'Fresh from the field. Bulk rate available.', null, 9, 'https://lh3.googleusercontent.com/aida-public/AB6AXuA8XMIHqrEy-hOtBabAbkZilX1xXa8woUq7m0ATLN-Y82HGpLOW9AhZJUkmzL6zGLmyw22l2vexovFTOyFURF80_sF-GI_4t0e6QbLRF5SyPngX32LL0EFhZTowe34RliZ2QtnL7zSL1cRopa5y7cfzfqHjuqB-QQwyEaN12bH9DKLxYwrFTejqQEsKyuKHIGNm9twYqkIC0uzIwjGWPZCsZ0UThLYLkcvsy9GOeiRLYjcF-oMfn-g6vQHGYMXWF3GHRBjUdJDTSS8'
    from public.categories where slug = 'vegetables'
  returning id into v_p;
  insert into public.product_variants (product_id, label, unit, price_paise, sort_order)
...
do $$ declare v_p uuid; begin
  insert into public.products (category_id, name, description, badge, sort_order, image_url)
  select id, 'Chikoo', 'Soft sapodilla, honey sweet.', null, 14, 'https://lh3.googleusercontent.com/aida-public/AB6AXuDfu1JsVQreEOdMtkjXvdwRGb6i7XOO3m_3obisLq0pZm8vIU9iolVuaVg4LHZXjMfF93XSUcA3yY-XvSYoeS-HmmZOLj2DIh9cqPnziAiBFQcyf9_kcVELo2Lb29NxjeV1K57zqGQ9YXQGG1Ql75DgY7wyr8GsR8LrBaqnriadJH-dVVXPh0ZNN0R_404cdLbVHAqtJgltZAzxnDGLzmJQVcf_wa59m5KGlr2JVgvvHZaAvYoppUIty8sE1V9qbFjQoZCAS-auTrs'
    from public.categories where slug = 'fruits'
  returning id into v_p;
  insert into public.product_variants (product_id, label, unit, price_paise, sort_order)
  values (v_p, 'Default', '1 kg', 10000, 0);
...
do $$ declare v_p uuid; begin
  insert into public.products (category_id, name, description, badge, sort_order, image_url)
  select id, 'Pineapple', 'Whole, ripe and tangy.', null, 15, 'https://lh3.googleusercontent.com/aida-public/AB6AXuApxaS_-PZ4_m3ayuO5CEmxHkPYIWtWggMyrre2s7d1HBQCi01J9Kz5L_1l08Sm8eGk3VWOF7lt13H6sGZcrIc9mYEbV1JpPUZL1XG3d8U28Qa0H7-Qe7XcdboD_AODCQL5L8QvB2BD60D5Uub2-5bXwP0xtCFADD508HhtEpD8-Sp5w-LHt_upTtdp35cmXYLcTRtqI0mRETfA-NCxguoCDoBgqKlb3GOk-ONszTi2ZOUDBPb1tLx1Stt7A4Ls22AhXFbs2tmc8Yo'
    from public.categories where slug = 'fruits'
  returning id into v_p;
  insert into public.product_variants (product_id, label, unit, price_paise, sort_order)
